 ...
 * @returns {any}
 */
export function apply_move_json(state_js, mv_js) {
    const ret = wasm.apply_move_json(state_js, mv_js);
    return ret;
}
...
export function get_legal_placements(state_js) {
    const ret = wasm.get_legal_placements(state_js);
    return ret;
}
 ...
 * @returns {any}
 */
export function legal_moves_for_piece_json(state_js, pos_js) {
    const ret = wasm.legal_moves_for_piece_json(state_js, pos_js);
    return ret;
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('Hive_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
