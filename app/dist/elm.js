...
var $author$project$Main$receiveNewState = _Platform_incomingPort('receiveNewState', $elm$json$Json$Decode$value);
...
var $author$project$Main$encodePlayer = function (player) {
	return $elm$json$Json$Encode$string(
		$author$project$Main$playerLabel(player));
};
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					'Win',
					$author$project$Main$encodePlayer(player))
				]));
	} else {
		return $elm$json$Json$Encode$string('Draw');
	}
};
var $author$project$Main$encodeUnplaced = function (unplaced) {
	return A2(
		$elm$json$Json$Encode$list,
		function (_v0) {
			var player = _v0.a;
					...
					[
						...
						function (_v1) {
							...
							return A2(
								...
								_List_fromArray(
									[
										$author$project$Main$encodePieceKind(kind),
...
var $author$project$Main$encodeGameState = function (state) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
...
var $author$project$Main$pieceKindDecoder = A2(
...
var $author$project$Main$playerDecoder = A2(
	...
	$elm$json$Json$Decode$string);
var $author$project$Main$pieceDecoder = A3(
	$elm$json$Json$Decode$map2,
	$author$project$Main$Piece,
	A2($elm$json$Json$Decode$field, 'kind', $author$project$Main$pieceKindDecoder),
...
var $author$project$Main$positionDecoder = A3(
	...
	A2($elm$json$Json$Decode$field, 'q', $elm$json$Json$Decode$int),
	A2($elm$json$Json$Decode$field, 'r', $elm$json$Json$Decode$int));
var $author$project$Main$boardDecoder = A2(
	...
	A2(
		...
		$elm$json$Json$Decode$list(
			A3(
				$elm$json$Json$Decode$map2,
				$elm$core$Tuple$pair,
				A2($elm$json$Json$Decode$index, 0, $author$project$Main$positionDecoder),
				A2(
...
var $author$project$Main$gameResultDecoder = $elm$json$Json$Decode$oneOf(
	_List_fromArray(
		[
			A2(
			$elm$json$Json$Decode$map,
			$author$project$Main$Win,
			A2($elm$json$Json$Decode$field, 'Win', $author$project$Main$playerDecoder)),
			A2(
			$elm$json$Json$Decode$andThen,
			function (str) {
				return (str === 'Draw') ? $elm$json$Json$Decode$succeed($author$project$Main$Draw) : $elm$json$Json$Decode$fail('Unknown result: ' + str);
			},
			$elm$json$Json$Decode$string)
		]));
...
var $author$project$Main$unplacedDecoder = $elm$json$Json$Decode$list(
	A3(
		$elm$json$Json$Decode$map2,
		$elm$core$Tuple$pair,
		A2($elm$json$Json$Decode$index, 0, $author$project$Main$playerDecoder),
		A2(
			$elm$json$Json$Decode$index,
			1,
			$elm$json$Json$Decode$list(
				A3(
					$elm$json$Json$Decode$map2,
					$elm$core$Tuple$pair,
					A2($elm$json$Json$Decode$index, 0, $author$project$Main$pieceKindDecoder),
...
var $author$project$Main$gameStateDecoder = A6(
	...
	A2($elm$json$Json$Decode$field, 'turn', $author$project$Main$playerDecoder),
	A2($elm$json$Json$Decode$field, 'turn_number', $elm$json$Json$Decode$int),
	A2($elm$json$Json$Decode$field, 'unplaced', $author$project$Main$unplacedDecoder),
	A2(
		$elm$json$Json$Decode$field,
		'result',
					...
					$elm$json$Json$Encode$object(
						_List_fromArray(
							[
								_Utils_Tuple2(
								'from',
								$author$project$Main$encodePosition(from)),
								_Utils_Tuple2(
								'to',
								$author$project$Main$encodePosition(to))
							])))
				]));
	}
};
var $author$project$Main$requestMovesForPiece = _Platform_outgoingPort(
	'requestMovesForPiece',
	function ($) {
		var a = $.a;
		var b = $.b;
		return A2(
...
var $author$project$Main$handlePieceSelection = F3(
...
var $author$project$Main$requestApplyMove = _Platform_outgoingPort(
	'requestApplyMove',
	function ($) {
		var a = $.a;
		var b = $.b;
	...
	function (state, fromPos, pos, model) {
		return A2($elm$core$List$member, pos, model.s) ? _Utils_Tuple2(
			...
			$author$project$Main$requestApplyMove(
				_Utils_Tuple2(
					$author$project$Main$encodeGameState(state),
					$author$project$Main$encodeMove(
						A2($author$project$Main$MovePiece, fromPos, pos))))) : A3($author$project$Main$handlePieceSelection, state, pos, model);
	});
		...
		return A2($elm$core$List$member, pos, model.t) ? _Utils_Tuple2(
			...
			$author$project$Main$requestApplyMove(
				_Utils_Tuple2(
					$author$project$Main$encodeGameState(state),
					$author$project$Main$encodeMove(
						A2($author$project$Main$Place, kind, pos))))) : _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
	});
	...
	function (state, pos, model) {
		...
		if (!_v0.a.$) {
			...
			if (!_v0.b.$) {
				...
				var _v2 = _v0.a;
				var _v3 = _v0.b;
				return A3($author$project$Main$handlePieceSelection, state, pos, model);
			}
		}
	});
var $author$project$Main$moveDecoder = $elm$json$Json$Decode$oneOf(
	_List_fromArray(
		[
			A2(
			$elm$json$Json$Decode$field,
			'Move',
			A2($elm$json$Json$Decode$field, 'to', $author$project$Main$positionDecoder)),
			A2(
			$elm$json$Json$Decode$field,
			'Place',
			A2($elm$json$Json$Decode$field, 'at', $author$project$Main$positionDecoder))
		]));
var $author$project$Main$requestLegalPlacements = _Platform_outgoingPort('requestLegalPlacements', $elm$core$Basics$identity);
var $author$project$Main$requestNewGame = _Platform_outgoingPort(
	'requestNewGame',
	function ($) {
	...
	A2(
		...
		function (q) {
			return A2(
				$elm$core$List$map,
				function (r) {
					return A2($author$project$Main$Position, q, r);
				},
...
var $author$project$Main$axialToPixel = F3(
	function (q, r, size) {
		return _Utils_Tuple2(
			size * (($elm$core$Basics$sqrt(3) * q) + (($elm$core$Basics$sqrt(3) / 2) * r)),
			size * ((3 / 2) * r));
	});
...
var $author$project$Main$hexCorner = F4(
	function (cx, cy, size, i) {
		var angleRad = $elm$core$Basics$degrees((60 * i) - 30);
		return _Utils_Tuple2(
			cx + (size * $elm$core$Basics$cos(angleRad)),
			cy + (size * $elm$core$Basics$sin(angleRad)));
	});
var $author$project$Main$hexPoints = F3(
	function (cx, cy, size) {
		return A2(
			$elm$core$String$join,
			' ',
			A2(
				...
				A2(
					$elm$core$List$map,
					A3($author$project$Main$hexCorner, cx, cy, size),
...
var $author$project$Main$lookupStack = F2(
	function (board, pos) {
		return A2(
			$elm$core$Maybe$map,
...
var $author$project$Main$renderHex = F2(
	function (model, pos) {
		var pieceHere = A2(
		...
		var hexStroke = _v1.a;
		var hexStrokeWidth = _v1.b;
		var baseAttrs = _List_fromArray(
			[
				$elm$svg$Svg$Attributes$points(
				A3($author$project$Main$hexPoints, 0, 0, 38)),
				$elm$svg$Svg$Attributes$fill(hexFill),
				$elm$svg$Svg$Attributes$stroke(hexStroke),
				$elm$svg$Svg$Attributes$strokeWidth(hexStrokeWidth),
				cursorStyle
			]);
		var attrs = isClickable ? _Utils_ap(
			baseAttrs,
			_List_fromArray(
				[
					$elm$svg$Svg$Events$onClick(
					$author$project$Main$ClickedHex(pos))
				])) : baseAttrs;
		return A2(
			$elm$svg$Svg$g,
			_List_fromArray(
							...
							[
								...
								_List_fromArray(
									[
										...
										$elm$svg$Svg$Attributes$fontSize('28')
									]),
								_List_fromArray(
									[
										$elm$svg$Svg$text(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$elm$svg$Svg$Attributes$viewBox('-300 -300 600 600'),
		...
		A2(
			$elm$core$List$map,
			$author$project$Main$renderHex(model),
			$author$project$Main$boardHexes));
};
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2($elm$html$Html$Attributes$style, 'background', '#ffdddd'),
					A2($elm$html$Html$Attributes$style, 'color', '#900'),
...
var $author$project$Main$resultOverlay = function (message) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				...
				A2($elm$html$Html$Attributes$style, 'padding', '32px 48px'),
				A2($elm$html$Html$Attributes$style, 'display', 'flex'),
				A2($elm$html$Html$Attributes$style, 'flex-direction', 'column'),
				A2($elm$html$Html$Attributes$style, 'align-items', 'center'),
				A2($elm$html$Html$Attributes$style, 'gap', '32px'),
				A2($elm$html$Html$Attributes$style, 'box-shadow', '0 4px 20px rgba(0,0,0,0.2)')
			]),
		_List_fromArray(
			[
				A2(
...
var $author$project$Main$gameOverBanner = function (model) {
	var _v0 = A2(
		$elm$core$Maybe$andThen,
		function ($) {
			return $.T;
	...
	if (_v0.$ === 1) {
		...
		if (!_v0.a.$) {
			...
			var _v1 = _v0.a;
			return $author$project$Main$resultOverlay('Draw!');
		}
	}
};
...
var $author$project$Main$deselectButton = A2(
	...
	_List_fromArray(
		[
			$elm$html$Html$Events$onClick($author$project$Main$ClickedDeselect),
	...
	return (count > 1) ? A2(
		...
		_List_fromArray(
			[
				...
				A2($elm$html$Html$Attributes$style, 'background', '#5577dd'),
				A2($elm$html$Html$Attributes$style, 'color', 'white'),
				A2($elm$html$Html$Attributes$style, 'border-radius', '50%'),
				A2($elm$html$Html$Attributes$style, 'width', '22px'),
...
var $author$project$Main$handSlot = F2(
	function (model, _v0) {
		var kind = _v0.a;
		var count = _v0.b;
		var isSelected = _Utils_eq(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					'border',
					isSelected ? '2px solid #e05555' : '1px solid #ddd'),
					A2($elm$html$Html$Attributes$style, 'background', '#fdf8e8'),
					A2($elm$html$Html$Attributes$style, 'display', 'flex'),
					A2($elm$html$Html$Attributes$style, 'align-items', 'center'),
					A2($elm$html$Html$Attributes$style, 'justify-content', 'center'),
					...
					$author$project$Main$ClickedHandPiece(kind))
				]),
			_List_fromArray(
				[
					$elm$html$Html$text(
					$author$project$Main$pieceGlyph(kind)),
					$author$project$Main$countBadge(count)
				]));
	});
...
var $author$project$Main$infoColumn = F2(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2($elm$html$Html$Attributes$style, 'border', '2px solid #333'),
					A2($elm$html$Html$Attributes$style, 'border-radius', '16px'),
					A2($elm$html$Html$Attributes$style, 'padding', '40px 56px'),
					A2($elm$html$Html$Attributes$style, 'display', 'flex'),
					A2($elm$html$Html$Attributes$style, 'flex-direction', 'column'),
					A2($elm$html$Html$Attributes$style, 'align-items', 'center'),
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Main$handToolbar(model),
				$author$project$Main$errorBanner(model),
				$author$project$Main$gameOverBanner(model),
				$author$project$Main$welcomeCard(model)
			]));
};
